...
@click.pass_context
def run(ctx: Context, name: Optional[str], commit: Optional[str], title: Optional[str], adhoc: bool, yaml: Optional[str], tags: Optional[Sequence[str]] = None) -> None:
    """
    ...
    start_pipeline(config, pipeline, project.id, commit, title, tags)
